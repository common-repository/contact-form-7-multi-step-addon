    ...
    <fieldset>
        ...
        <table class="form-table">
            ...
            <?php if ($show_additional_fields) : ?>
                <tr>
                    <th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-id' ); ?>"><?php esc_html_e('Id attribute', 'contact-form-multi-step-addon'); ?></label></th>
                    <td><input type="text" name="id" class="idvalue oneline option" id="<?php echo esc_attr( $args['content'] . '-id' ); ?>" /></td>
                </tr>
                <tr>
                    <th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-class' ); ?>"><?php esc_html_e('Class attribute', 'contact-form-multi-step-addon'); ?></label></th>
...
<div class="insert-box">
    ...
    <div class="submitbox">
        <input type="button" class="button button-primary insert-tag" value="<?php esc_attr_e('Insert Tag', 'contact-form-multi-step-addon'); ?>" />
    </div>
    <br class="clear" />
</div>
